...
#define DRM_ADC_VOUT1						HAL_GPIO_ReadPin(GPIOG, GPIO_PIN_15)										//izmijenjen
#define DRM_ADC_CURR2			  		HAL_GPIO_ReadPin(GPIOE, GPIO_PIN_2)										  //izmijenjen			
...
#define BAL1_DISABLE						HAL_GPIO_WritePin(GPIOF, GPIO_PIN_6, GPIO_PIN_RESET)
#define PWR1_ENABLE							HAL_GPIO_WritePin(GPIOF, GPIO_PIN_7, GPIO_PIN_SET)
#define PWR1_DISABLE						HAL_GPIO_WritePin(GPIOF, GPIO_PIN_7, GPIO_PIN_RESET)
#define	CHG1_ENABLE							HAL_GPIO_WritePin(GPIOF, GPIO_PIN_8, GPIO_PIN_RESET)
#define	CHG1_DISABLE						HAL_GPIO_WritePin(GPIOF, GPIO_PIN_8, GPIO_PIN_SET)
#define CHG1_INFO								HAL_GPIO_ReadPin(GPIOF, GPIO_PIN_9)
#define BAL2_ENABLE							HAL_GPIO_WritePin(GPIOF, GPIO_PIN_10, GPIO_PIN_SET)
#define BAL2_DISABLE						HAL_GPIO_WritePin(GPIOF, GPIO_PIN_10, GPIO_PIN_RESET)
#define PWR2_ENABLE							HAL_GPIO_WritePin(GPIOF, GPIO_PIN_11, GPIO_PIN_SET)
#define PWR2_DISABLE						HAL_GPIO_WritePin(GPIOF, GPIO_PIN_11, GPIO_PIN_RESET)
#define	CHG2_ENABLE							HAL_GPIO_WritePin(GPIOA, GPIO_PIN_5, GPIO_PIN_RESET)
#define	CHG2_DISABLE						HAL_GPIO_WritePin(GPIOA, GPIO_PIN_5, GPIO_PIN_SET)
#define CHG2_INFO								HAL_GPIO_ReadPin(GPIOA, GPIO_PIN_6)

//SRM Control
#define	SRM_DIN_HIGH						HAL_GPIO_WritePin(GPIOB, GPIO_PIN_0, GPIO_PIN_SET)
...
#define	SRM_SYNC_HIGH						HAL_GPIO_WritePin(GPIOB, GPIO_PIN_10, GPIO_PIN_SET)
#define	SRM_SYNC_LOW						HAL_GPIO_WritePin(GPIOB, GPIO_PIN_10, GPIO_PIN_RESET)
#define SRM1_RDY2								HAL_GPIO_ReadPin(GPIOB, GPIO_PIN_11)
#define SRM2_CS1_SET						HAL_GPIO_WritePin(GPIOB, GPIO_PIN_12, GPIO_PIN_SET)
#define SRM2_CS1_RESET					HAL_GPIO_WritePin(GPIOB, GPIO_PIN_12, GPIO_PIN_RESET)
#define SRM2_RDY1								HAL_GPIO_ReadPin(GPIOB, GPIO_PIN_13)
